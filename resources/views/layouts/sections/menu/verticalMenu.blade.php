...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    {{-- ====== MENU PEGAWAI + SUBMENU ====== --}}
    <!-- RUJUKAN PEGAWAI (RP) -->
    <li class="menu-item {{ request()->segment(1) === 'staffs' ? 'active open' : '' }}">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon mdi mdi-home-variant-outline"></i>
        <div>Menu Utama</div>
      </a>
    </li>

    <!-- RUJUKAN PEGAWAI (RP) -->
    <li class="menu-item {{ request()->routeIs('staffs.*')}}">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon mdi mdi-clipboard-account-outline"></i>
        <div>Modul Personel</div>
      </a>

      <ul class="menu-sub">
        <li class="menu-item {{ request()->routeIs('staffs.index') ? 'active' : '' }}">
          <a href="{{ route('staffs.index') }}" class="menu-link">
            <div>Rujukan Pegawai</div>
          </a>
        </li>

        <li class="menu-item ">
          <a href="{{ route('org.index') }}" class="menu-link">
            <div>Rujukan Organisasi</div>
          </a>
        </li>

        <li class="menu-item ">
          <a href="{{ route('services.index') }}" class="menu-link">
            <div>Rujukan Perkhidmatan</div>
          </a>
        </li>
      </ul>
    </li>

    <!-- RUJUKAN ORGANISASI (RO) -->
    <!-- <li class="menu-item ">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon mdi mdi-office-building-outline"></i>
        <div>Modul Organisasi</div>
      </a>
...
@push('styles')
<style>
  /* Pegawai - bila active / open */
  .menu-pegawai.active > .menu-link,
  .menu-pegawai.open > .menu-link,
  .menu-pegawai.active.open > .menu-link {
    background-color: #696cff !important;
    color: #fff !important;
  }

  .menu-pegawai.active > .menu-link .menu-icon,
  .menu-pegawai.open > .menu-link .menu-icon,
  .menu-pegawai.active.open > .menu-link .menu-icon {
    color: #fff !important;
  }

  /* optional: kalau ada icon chevron */
  .menu-pegawai.active > .menu-link:after,
  .menu-pegawai.open > .menu-link:after {
    color: #fff !important;
  }
</style>
@endpush
