...
$loggedUser = Auth::user() ?? Auth::guard('staff')->user();

$displayName = 'Pengguna';
$userRole = 'Pengguna';

if (Auth::check()) {
    $displayName = Auth::user()->name ?? Auth::user()->nokp ?? 'Pentadbir';
    $userRole = 'Pentadbir';
} elseif (Auth::guard('staff')->check()) {
    $displayName = Auth::guard('staff')->user()->nama ?? Auth::guard('staff')->user()->mykad ?? 'Pengguna';
    $userRole = 'Pengguna';
}
@endphp
